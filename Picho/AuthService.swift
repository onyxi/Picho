...
//                    DataService().createNewUser(uid: user!.uid, email: email, password: password, username: email)
...
//                        DataService().getAndStoreLoggedInUserInfo(userID: user!.uid, loggingIn: true)
//                    })
//                    
//                } else {
